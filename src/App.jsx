...
const ALL_SCHOOLS_DATA = [
  ...
  },
  {
    ...
    parkerFit: { business: true, aviation: false, theology: true, notes: "CUI checks multiple boxes: AACSB business, Lutheran Christ College theology, and HIGH setter need heading into 2029. Program ranked #18 nationally at D-I — real competitive volleyball. Irvine location is attractive and the faith-integrated environment fits Parker's values." },
  ...
  },
  {
    ...
    parkerFit: { business: true, aviation: false, theology: false, notes: "UCSB is a competitive Target (26% acceptance) but in-state tuition makes finances workable. Beach campus in Santa Barbara is world-class. #10 nationally means elite volleyball. Economics pathway is strong for business-minded students. Moderate setter need suggests opportunity in the 2029 class." },
  ...
  },
  {
    ...
    coaches: [{ name: "Head Coach TBD", role: "Head Coach", email: "athletics@hiu.edu", phone: "" }],
    setters: [],
    azRadar: [],
...
const buildTemplate = (id, school) => {
  ...
  const templates = {
    ...
    tournament: {
      ...
      subject: `Parker Henderson | 2029 Setter | [Tournament Name] Schedule`,
    ...
    video: {
      ...
      subject: `Parker Henderson | 2029 Setter | 6'2" | New Highlight Video`,
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className="text-blue-300 text-xs font-bold uppercase tracking-widest">Brophy College Prep · AZ Fear 17s · Class of 2029</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 pb-20 pt-8 space-y-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="font-black text-slate-800 uppercase tracking-widest text-base" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>Recruiting Calendar — Class of 2029</h3>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { when: "Feb 2029", what: "National Signing Day — final letters of intent due", color: "border-emerald-400 bg-emerald-50", icon: "🏆" },
            ].map((item, i) => (
        ...
        <div style={{ background: "linear-gradient(135deg, #0f172a, #1e3a5f)" }} className="px-8 py-6">
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-8">
            <div>
              <div className="flex items-center gap-3 mb-0.5">
                <ShieldCheck className="text-blue-400 w-4 h-4" />
                <span className="text-blue-300 text-xs font-bold uppercase tracking-widest">Parker Henderson · Brophy CP · AZ Fear 17s · Class of 2029</span>
              </div>
              <h1 className="font-black text-white text-3xl tracking-tight" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
              ...
              {(sel.setters?.length > 0) && (
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                  ...
                  <div className="mt-4 p-3 rounded-xl border border-dashed border-slate-300 bg-slate-50/50">
                    <div className="text-[10px] font-bold text-slate-500 uppercase tracking-wide mb-1">Class of 2029 Opening</div>
                    <div className={`text-sm font-bold ${sel.setterNeed === 'High' ? 'text-rose-600' : sel.setterNeed === 'Med' ? 'text-amber-600' : 'text-slate-400'}`}>
                      {sel.setterNeed === 'High' ? '🟢 Strong — multiple roster spots likely open' : sel.setterNeed === 'Med' ? '🟡 Moderate — 1 spot likely available' : '🔴 Limited — roster appears full through 2029'}
                    </div>
                  </div>
                </div>
              )}
